            ...
            <div className="container mx-auto px-4 sm:px-8 lg:px-24">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                        {/* Basic Plan */}
                        <div className="rounded-lg border border-gray-300 overflow-hidden transition-all duration-200 hover:shadow-lg hover:border-[#03b296] flex flex-col">
                            ...
                            <div className="p-6 space-y-4 flex-grow">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-3 text-gray-600">6 hours/day</span>
                                </div>
                                <div className="flex items-center">
                                    <svg className="h-5 w-5 text-[#03b296]" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                            ...
                            <div className="px-6 pb-6 mt-auto">
                                <a
                                    href="#contact"
                                    className="block w-full bg-[#03b296] text-white px-6 py-3 rounded-lg hover:opacity-90 transition-all duration-200 text-center"
                                >
                                    Hire Now
                                </a>
                            </div>
                        ...
                        {/* Standard Plan */}
                        <div className="rounded-lg border border-[#03b296] overflow-hidden transition-all duration-200 hover:shadow-lg relative flex flex-col">
                            <div className="absolute top-0 right-0 bg-[#03b296] text-white px-3 py-1 text-xs font-semibold rounded-bl-lg">
                                Popular
                            </div>
                    ...
                    <div className="mt-12 bg-white rounded-lg p-6 border border-[#03b296]">
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Benefits of Remote Hiring</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
                            <div className="flex items-start">
                                <svg className="h-5 w-5 text-[#03b296] mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                </svg>
